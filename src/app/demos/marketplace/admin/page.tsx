    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-mute mt-1">
          Willkommen, Rundi Xie. (Demo-Verkäufer)
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="rounded-2xl border border-line bg-white p-5">
          ...
          <p className="mt-1 text-xs text-mute">
            Cash {formatEuro(stats.cashRevenue)} · Gutschein{" "}
            {formatEuro(stats.giftCardRevenue)}
          </p>
        </div>
        <div className="rounded-2xl border-2 border-accent bg-accent/5 p-5">
          ...
          <p className="text-3xl font-black mt-1 text-accent">
            {formatEuro(stats.sellerBalanceCents)}
          </p>
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-sm text-mute">
              ...
              <strong>{formatEuro(stats.sellerBalanceCents)}</strong>. Bei einer
              Auszahlung wird eine Gebühr von 5% + 15&nbsp;Cent erhoben.
            </p>
          </div>
          <button
            disabled
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <a
            href="/demos/marketplace/admin/products"
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-mute">
                    ...
                    {o.giftCardDeduction
                      ? ` · Gutschein ${formatEuro(o.giftCardDeduction)}`
                      : ""}
                  </p>
                </div>
                <div className="text-right">
                  <span className="text-sm font-bold">
                    {formatEuro(o.amountCents + (o.giftCardDeduction ?? 0))}
                  </span>
                  {o.giftCardDeduction ? (
                    <p className="text-[11px] text-mute">
                      Mit Gutschein bezahlt
                    </p>
                  ) : (
                    <p className="text-[11px] text-mute">Direkt bezahlt</p>
                  )}
                </div>
              </div>
            ))}
